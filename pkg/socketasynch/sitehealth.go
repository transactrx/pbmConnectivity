...
func (pc *SocketAsyncConnect) EvaluateSiteHealth() {
	activeCount := 0
	var pausable []*Site
...
func (pc *SocketAsyncConnect) StartSiteResetMonitor(frequency time.Duration) {
	go func() {
		for {
...
func (pc *SocketAsyncConnect) CheckSites() {
...
func (pc *SocketAsyncConnect) CheckPausableSites(pausable []*Site, activeCount *int) {
